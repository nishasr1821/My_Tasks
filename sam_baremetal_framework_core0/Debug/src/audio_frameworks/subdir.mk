...
src/audio_frameworks/audio_framework_16ch_sam_and_automotive_fin_arm.o: ../src/audio_frameworks/audio_framework_16ch_sam_and_automotive_fin_arm.c
	...
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -D_DEBUG -DCORE0 @includes-31ae247f7a5df50ffada24837680fd31.txt -Wall -c -mproc=ADSP-SC589 -msi-revision=1.0 -MMD -MP -MF"src/audio_frameworks/audio_framework_16ch_sam_and_automotive_fin_arm.d" -o  "$@" "$<"
...
src/audio_frameworks/audio_framework_8ch_sam_and_audioproj_fin_arm.o: ../src/audio_frameworks/audio_framework_8ch_sam_and_audioproj_fin_arm.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore ARM Bare Metal C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -D_DEBUG -DCORE0 @includes-31ae247f7a5df50ffada24837680fd31.txt -Wall -c -mproc=ADSP-SC589 -msi-revision=1.0 -MMD -MP -MF"src/audio_frameworks/audio_framework_8ch_sam_and_audioproj_fin_arm.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
src/audio_frameworks/audio_framework_a2b_bypass_sc589_arm.o: ../src/audio_frameworks/audio_framework_a2b_bypass_sc589_arm.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore ARM Bare Metal C Compiler'
	arm-none-eabi-gcc -g -gdwarf-2 -ffunction-sections -fdata-sections -D_DEBUG -DCORE0 @includes-31ae247f7a5df50ffada24837680fd31.txt -Wall -c -mproc=ADSP-SC589 -msi-revision=1.0 -MMD -MP -MF"src/audio_frameworks/audio_framework_a2b_bypass_sc589_arm.d" -o  "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
