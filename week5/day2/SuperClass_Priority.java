...
public class SuperClass_Priority {
	...
	public void setuplogin(String url, String uName, String passwrd) {
	  ...
	  System.out.println("CreateLead"); driver.close(); 
	  ...
	  @Test//(dependsOnMethods={"week5.day2.SuperClass.runCreateLead","week5.day2.SuperClass.runDeleteLead"}) 
